...
function verifyJWToken(req, res, next) {
    ...
    jwt.verify(token, "05f7ce5d2b674e981eec3ba4f4f473d744a8d1c466b73475b965642e8b16220a738c6113e3029c6dc351c24edd05ec43aeeb5145034bfb39804e566397a3b7f0", (err, decoded) => {
        if (err) {
...
const uri = `mongodb+srv://admin:Dr2GWSyl7us0HOPe@cars-parts.ncua4.mongodb.net/?retryWrites=true&w=majority`;
